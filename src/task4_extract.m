...
features_to_remove = {'Track ID', 'GenreID', 'File', 'Genre', 'Type'};
...
writetable(data, 'features/task4_filtered_30s.txt', 'Delimiter', '\t');
writematrix(labels, '../data/30s_labels.txt', 'Delimiter', '\t');